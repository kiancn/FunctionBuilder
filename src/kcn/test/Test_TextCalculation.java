...
public class Test_TextCalculation
{
    public static void main(String... args)
    {
        ...
        System.out.println("Increase from 100 to 150 is a %-increase of: " + increase.calc(200,100));
        System.out.println("Increase from 100 to 150 is a %-increase of: " + increase.calc(150,99));
